"""Implementation of the NewOptimizer and baseline optimizers."""
...
class NewOptimizer(Optimizer):
    def __init__(self, params, lr=1e-3, beta1=0.9, beta2=0.999, epsilon=1e-8, 
                 betas_aggmo=[0.0, 0.9, 0.99], weight_decay=0):
        defaults = dict(
            lr=lr,
            beta1=beta1,
            beta2=beta2,
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for param in group['params']:
                ...
                # Combined update
                param.data.sub_(adam_update + lr * aggmo_update / total_moments)
